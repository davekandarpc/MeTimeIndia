...
import com.metime.R;
import com.metime.camera2.util.Camera2Listener;
import com.metime.camera2.util.CameraUtil;
import com.metime.camera2.widget.AutoFitTextureView;
...
public abstract class Camera2Fragment extends Fragment implements Camera2Listener, MediaRecorder.OnInfoListener {
    ...
    public abstract void OnMediaRecorderInfo(MediaRecorder mr, int what, int extra);
    ...
    public void onResume() {
        ...
        if (mCameraLayout.isAvailable()) {
            ...
            /*CameraRenderer renderer = new CameraRenderer(getContext());
            mCameraLayout.setSurfaceTextureListener(renderer);*/
    ...
    protected void setUpMediaRecorder() throws IOException {
        ...
        mMediaRecorder.setMaxDuration(getDuration());
    ...
    public void onInfo(MediaRecorder mr, int what, int extra) {
        OnMediaRecorderInfo(mr, what, extra);
