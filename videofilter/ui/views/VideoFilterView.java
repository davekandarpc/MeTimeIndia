package com.metime.videofilter.ui.views;
...
import com.metime.videofilter.render.MovieRenderThread;
import com.metime.videofilter.render.MovieRenderer;
import com.metime.videofilter.render.RecordRenderThread;
import com.metime.videofilter.utils.ConfigUtils;
import com.metime.videofilter.utils.VideoInfoUtils;
...
public class VideoFilterView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private String mOutputFile = ConfigUtils.getInstance().getOutPutVideoPath(); //Environment.getExternalStorageDirectory().getPath() + "/output.mp4";
    ...
    public void handleSaveCompleted() {
        ...
        VideoInfoUtils.combineVideo(ConfigUtils.getInstance().getVideoPath(), mOutputTempleFile, ConfigUtils.getInstance().getOutPutVideoPath());
        Toast.makeText(getContext(), "Video Saved Successfully：", Toast.LENGTH_SHORT).show();

        onSaveProgress.onComplete();
    }
